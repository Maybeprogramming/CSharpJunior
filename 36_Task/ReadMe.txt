...
CheckPositionForEmpty() - Check не передает конкретики действий,.  
Например, ПроверьтеТрубы - не понятен результат 
- текут трубы или нет, покрашены или нет, 
дюймовые или нет - их проверили, 
но на предмет чего непонятно. 
Старайтесь не использовать данное слово в именовании методов. 
В данном  случае больше подходит TryRemovePosition(). Исправьте у себя
